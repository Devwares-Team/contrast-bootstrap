export const MultiSelect = (function () {
  ...
  var c = {
    ...
    u = {
      ...
      dropdownShown: 'multiselect-select--opened',
      ...
      autocompleteInput: 'multiselect-autocomplete',
      selectedLabel: 'multiselect-selected-label',
      selectedOption: 'multiselect-option--selected',
      placeholderHidden: 'multiselect-placeholder--hidden',
      optionHidden: 'multiselect-option--hidden',
    };
  return (function () {
    function t(n, i) {
      e(this, t),
