export const Notification = (element, options) => {
  const optionsBool =
    typeof options === 'object' && options !== null ? true : false;
  var optionsDefault = {
    sticky:
      optionsBool &&
      options.sticky !== null &&
      options.sticky !== undefined &&
      typeof options.sticky === 'boolean'
        ? options.sticky
        : true,
    visibleDuration:
      optionsBool &&
      options.visibleDuration !== null &&
      options.visibleDuration !== undefined &&
      typeof options.visibleDuration === 'number'
  ...
  if (optionsDefault.sticky === false) {
    setTimeout(() => {
      remove(element);
    }, optionsDefault.visibleDuration);
  }
  return {
    dismiss,
  };
